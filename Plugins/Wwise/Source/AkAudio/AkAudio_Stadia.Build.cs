...
public class AkUEPlatform_Stadia : AkUEPlatform
{
	public AkUEPlatform_Stadia(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
	...
	public override List<string> GetPublicLibraryPaths()
	{
		...
		{
			Path.Combine(ThirdPartyFolder, "GGP", akConfigurationDir, "lib")
		};
	}
...
public class AkUEPlatform_Quail : AkUEPlatform_Stadia 
{
	public AkUEPlatform_Quail(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
}